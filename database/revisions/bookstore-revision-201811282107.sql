...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 28, 2018 at 07:06 PM
...
INSERT INTO `addresses` (`id`, `client_id`, `phone_id`, `country_id`, `label`, `address_line_1`, `address_line_2`, `address_line_3`, `locality`, `region`, `postal_code`) VALUES
(11, 1, 1, 1, 'Nėra.', 'Nėra.', 'Nėra.', 'Nėra.', 'Nėra.', 'Nėra.', '');
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `authorization_key` varchar(255) COLLATE utf8_lithuanian_ci DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `client_id`, `address_id`, `status`, `updated_at`, `created_at`) VALUES
(2, 1, 11, 0, '2018-11-27 12:36:38', '2018-11-27 12:36:38');
...
INSERT INTO `phone_numbers` (`id`, `client_id`, `number`, `label`) VALUES
(1, 1, '112', 'Pagrindinis');
...
ALTER TABLE `profiles`
  ADD CONSTRAINT `fk_profile_clients1` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
